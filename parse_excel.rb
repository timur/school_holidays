...
6.upto(261) do |n|     
  ...
  from_weihnachtsferien = before[13]
  ...
  data["Weihnachtsferien"] << { "region" => iso, "from" => from_weihnachtsferien, "to" => to_weihnachtsferien } if from_weihnachtsferien.class == Date    
end    
